    ...
    <div className=" bg-black text-white rounded-t-3xl mt-8 md:mt-0">
      <div className=" flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className=" w-full md:w-1/4">
          <h1 className=" font-semibold text-xl pb-4">Food</h1>
          <p className=" text-sm">
            Indulge in a symphony of flavors, where each plate is a canvas
            flavors culinary excellence.
          </p>
        </div>
        <div>
        ...
        <div>
            ...
            <nav className=" flex flex-col gap.2">
                ...
                <a className="hover:text-brightColor transition-all cursor-pointer" href="">Premiun Menu</a>
                {/* <a className="hover:text-brightColor transition-all cursor-pointer" href="">xxx</a>
                <a className="hover:text-brightColor transition-all cursor-pointer" href="">xxxxx</a> */}
            </nav>
        </div>
        <div>
            ...
            <nav className=" flex flex-col gap.2">
                ...
                <a className="hover:text-brightColor transition-all cursor-pointer" href="">Delivery</a>
            </nav>
        </div>
      </div>
      <div>
        <p className=" text-center py-4">
            ...
            <span className=" text-secundaryColor"> AlvaradoDevs</span> | All rights reserved
        </p>
      </div>
    </div>
  );
