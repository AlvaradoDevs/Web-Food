    ...
    <div className="w-full md:w-1/3 bg-white border-2 border-lightText md:border-none p-5 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
      <div>
        <p className=" text-lightText text-justify" >
          ...
          mollitia quibusdam voluptates voluptatem asperiores exercitationem
          libero? Harum quidem, adipisci aut quaerat quisquam, explicabo
          voluptatum amet doloremque necessitatibus, omnis maiores?
        </p>
      </div>
